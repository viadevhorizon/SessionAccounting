        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exams_Lectors_LectorId",
                        column: x => x.LectorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LectorSubjects", x => new { x.SubjectId, x.LectorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamStudentAttendances", x => new { x.ExamId, x.StudentId });
                    table.ForeignKey(
                        name: "FK_ExamStudentAttendances_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamStudentAttendances_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamStudentAttendances_StudentId",
                table: "ExamStudentAttendances",
                column: "StudentId");
